...
public interface BlogRepository extends PagingAndSortingRepository<Blog, Long> {
    ...
    Page<Blog> findBlogsByTagsName(@Param("name") String tagName, Pageable pageable);
    Page<Blog> findBlogsByTagsIn(Set<Tag> tags, Pageable pageable);
    List<Blog> findBlogsByTagsName(@Param("name") String tagName);
}
